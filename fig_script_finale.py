...
plt.plot(BalanceIE,moduleK_norm,'k')
plt.xlim(0,1.6)
plt.xlabel(r'$K_i/K_e$')
plt.ylim(0,7)
plt.ylabel(r'$Amplitude \: (\tilde{K}(60\pi)) (norm.)$')
...
#plt.savefig("C:\\Users\\Mathilde\\Documents\\Master_2\\TINS\\Papier\\fig.pdf")
