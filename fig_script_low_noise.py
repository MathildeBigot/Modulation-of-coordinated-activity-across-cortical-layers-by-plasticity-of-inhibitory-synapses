...
iter=3000  #nombre de trials pour moyenner les spikes
...
plt.bar(time2-0.1,rate0,0.002,facecolor="white",edgecolor='black')
plt.xlim(0,0.1)
...
plt.plot(time2-0.1,data_fit0, 'r',linewidth=1.5)
...
plt.bar(time2-0.1,rate1,0.002,facecolor="white",edgecolor='black')
plt.xlim(0,0.1)
plt.ylim(0,49)
plt.plot(time2-0.1,data_fit1, 'y',linewidth=1.5)
...
plt.bar(time2-0.1,rate2,0.002,facecolor="white",edgecolor='black')
plt.xlim(0,0.1)
plt.plot(time2-0.1,data_fit2, 'g',linewidth=1.5)
#graduationy=[r'$0$', r'$5$',r'$ 10 $',r'$15$',r'$20$']
...
plt.bar(time2-0.1,rate3,0.002,facecolor="white",edgecolor='black')
plt.xlim(0,0.1)
plt.plot(time2-0.1,data_fit3, 'b',linewidth=1.5)
...
plt.plot(BalanceIE,10*moduleK_norm,'k')
plt.xlim(0,1.6)
plt.xlabel(r'$K_i/K_e$')
#plt.ylim(0,7)
...
ax.xaxis.set_ticklabels(graduationx)
plt.plot(Ki_Ke,10*modulo_norm,'ko')
ax.spines['top'].set_visible(False)
